...
/** Color asociado a cada nivel del semáforo (Existencia → Mejora continua). */
export const SEMAFORO_COLOR: Record<Semaforo, string> = {
  Existencia: 'bg-red-500',
  Apropiación: 'bg-orange-500',
  Pertinencia: 'bg-yellow-500',
...
export const SEMAFORO_SHADOW: Record<Semaforo, string> = {
  ...
  Apropiación: 'shadow-lg shadow-orange-500/40',
  Pertinencia: 'shadow-lg shadow-yellow-500/40',
